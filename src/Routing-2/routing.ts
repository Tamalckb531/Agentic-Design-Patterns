...
/*
This code just doing this bruh! 
const result = await routerLLM(request);

if (result === "booker") return booking_handler(request);
if (result === "info") return info_handler(request);
