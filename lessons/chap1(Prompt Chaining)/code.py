...
# The full chain passes the output of the extraction into the 'specifications'
...
input_text = "The new laptop model features a 3.5 GHz octa-core processor, 16GB of RAM and a 1 TB NVMe SSD"
